...
import {useSetSearchResult} from "../../contexts/SearchContext";
                ...
                <Col>
                    {searchResult && searchResult.results &&
                        <InfiniteScroll
                            ...
                            children={
                                searchResult?.results?.map((article, index) => (
                                    <SearchResultItem key={index} article={article}></SearchResultItem>))
                            }
                        >
                        </InfiniteScroll>
